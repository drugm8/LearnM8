...
import scripts.meeko.macrocycle as macrocycle
...
class MoleculePreparation:
    ...
    def __init__(
        ...
        min_ring_size=macrocycle.DEFAULT_MIN_RING_SIZE,
        max_ring_size=macrocycle.DEFAULT_MAX_RING_SIZE,
        keep_chorded_rings=False,
        keep_equivalent_rings=False,
        double_bond_penalty=macrocycle.DEFAULT_DOUBLE_BOND_PENALTY,
