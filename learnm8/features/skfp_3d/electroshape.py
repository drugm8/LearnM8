"""ElectroShape fingerprints using scikit-fingerprints."""
...
class ElectroShapeFeaturizer(SkfpFeaturizer):
    """ElectroShape 3D + electrostatic descriptors using scikit-fingerprints.

    Combines 3D shape with electrostatic information (15-D).
    ...
    def __init__(
        ...
        """Initialize ElectroShape descriptor calculator.
        ...
        Note:
            ...
            ElectroShape combines 3D shape with electrostatic properties.
            Dimension: 15 descriptors.
        """
        fp = ElectroShapeFingerprint(n_jobs=n_jobs)
    ...
    def get_description(self) -> str:
        return 'ElectroShape 3D + electrostatic descriptors (15-D, requires conformers)'
