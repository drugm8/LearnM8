...
try:
    ...
    SkfpFeaturizer = None
    MorganFeaturizer = None
    MACCSFeaturizer = None
    AvalonFeaturizer = None
    AtomPairFeaturizer = None
    TopologicalTorsionFeaturizer = None
    RDKitFeaturizer = None
    PubChemFeaturizer = None
    MordredFeaturizer = None
    KlekotaRothFeaturizer = None
    LaggnerFeaturizer = None
    PatternFeaturizer = None
    LayeredFeaturizer = None
    MAP4Featurizer = None
    MHFPFeaturizer = None
    SECFPFeaturizer = None
    LingoFeaturizer = None
    ERGFeaturizer = None
    RDKit2DDescriptorsFeaturizer = None
    EStateFeaturizer = None
    GhoseCrippenFeaturizer = None
    MQNsFeaturizer = None
    VSAFeaturizer = None
    BCUT2DFeaturizer = None
    PhysiochemicalPropertiesFeaturizer = None
    PharmacophoreFeaturizer = None
    FunctionalGroupsFeaturizer = None
    WHIMFeaturizer = None
    USRFeaturizer = None
    USRCATFeaturizer = None
    E3FPFeaturizer = None
    GETAWAYFeaturizer = None
    MORSEFeaturizer = None
    RDFFeaturizer = None
    AutocorrFeaturizer = None
    ElectroShapeFeaturizer = None
...
FEATURIZERS_2D = [
    name for name, cls in FEATURIZER_REGISTRY.items()
