...
class MixedEnsemble(EnsembleLearner):
    ...
    def __init__(self, random_state: int = 42, **kwargs):
        ...
        """
        learners = [
            RandomForestLearner(n_estimators=100, random_state=random_state),
            LinearRegressionLearner(alpha=1.0, random_state=random_state),
            XGBoostLearner(learning_rate=0.1, random_state=random_state)
        ]
