...
@pytest.mark.unit
def test_truncated_file_fails_fast(populated_v2_cache: Path):
    file_size = populated_v2_cache.stat().st_size
...
@pytest.mark.unit
def test_no_silent_fallback_on_corruption(populated_v2_cache: Path):
