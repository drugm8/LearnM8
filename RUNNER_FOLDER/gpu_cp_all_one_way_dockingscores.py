...
from learners.chemprop_gpu_learner import chemprop_gpu_learner
#############ADJUST THESE########################
BATCH_SIZE = 1000
AL_CYCLES = 10
TOPX = 5000
...
for do in docking_scores:
    ...
    learner = chemprop_gpu_learner(greedy_query_function, docked_inital_random_sample.loc[:,"SMILES"].values, docked_inital_random_sample.loc[:,do].values, batch_size=BATCH_SIZE)
