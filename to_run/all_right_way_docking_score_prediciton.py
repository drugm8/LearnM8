...
for do in docking_scores:
    ...
    learner = rf_learner(greedy_query_function, docked_inital_random_sample.loc[:,"SMILES"].values, docked_inital_random_sample.loc[:,do].values, batch_size=BATCH_SIZE)
