...
Output:
    validation/reports/large_scale/ampc_1M_rf_ensemble_mixed_validation/
...
def main():
    ...
    base_output_dir = Path('validation/reports/large_scale/ampc_1M_rf_ensemble_mixed_validation')
