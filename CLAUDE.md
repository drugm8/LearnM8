...
<!-- SPECKIT:START -->
## Current Feature: 023-acquisition-aware-uncertainty
**Phase**: plan (complete)
**Spec**: specs/023-acquisition-aware-uncertainty/spec.md
**Plan**: specs/023-acquisition-aware-uncertainty/plan.md
...
- Version bump 0.10.0 → 0.11.0 (pre-1.0 minor; polars-style versioning)
<!-- SPECKIT:END -->
